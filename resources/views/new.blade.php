                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-muted small">{{ __('The command that should be sent to server processes to stop them gracefully. If you need to send a') }} <code>{{ __('SIGINT') }}</code> {{ __('you should enter') }}
