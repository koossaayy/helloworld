                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">{{ __('Think of a Nest as a category. You can put multiple Eggs in a nest, but consider putting only Eggs that are related to each other in each Nest.') }}</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="pName" class="form-label">{{ __('Name') }}</label>
                                <input type="text" id="pName" name="name" value="{{ old('name') }}" class="form-control" />
                                <p class="text-muted small">{{ __('A simple, human-readable name to use as an identifier for this Egg. This is what users will see as their game server type.') }}</p>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <p class="text-muted small">{{ __('The docker images available to servers using this egg. Enter one per line. Users will be able to select from this list of images if more than one value is provided.') }}</p>
                            </div>
                            <div class="form-group">
                                ...
                                <p class="text-muted small">{{ __('The default startup command that should be used for new servers created with this Egg. You can change this per-server as needed.') }}</p>
                            </div>
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">{{ __('Additional features belonging to the egg. Useful for configuring additional panel modifications.') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="alert alert-warning">
                                <p>{{ __("All fields are required unless you select a separate option from the 'Copy Settings From' dropdown, in which case fields may be left blank to use the values from that option.") }}</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <p class="text-muted small">{{ __('If you would like to default to settings from another Egg select it from the dropdown above.') }}</p>
                            </div>
                            <div class="form-group">
                                ...
                                <p class="text-muted small">{{ __('The command that should be sent to server processes to stop them gracefully. If you need to send a') }} <code>{{ __('SIGINT') }}</code> {{ __('you should enter') }} <code>{{ __('^C') }}</code> {{ __('here.') }}</p>
                            </div>
                            <div class="form-group">
                                ...
                                <p class="text-muted small">{{ __('This should be a JSON representation of where log files are stored, and whether or not the daemon should be creating custom logs.') }}</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <p class="text-muted small">{{ __('This should be a JSON representation of configuration files to modify and what parts should be changed.') }}</p>
                            </div>
                            <div class="form-group">
                                <label for="pConfigStartup" class="form-label">{{ __('Start Configuration') }}</label>
                                ...
                                <p class="text-muted small">{{ __('This should be a JSON representation of what values the daemon should be looking for when booting a server to determine completion.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
