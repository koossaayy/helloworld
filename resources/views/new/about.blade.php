        ...
        <div class="config content-container card card-master">
            ...
            <dl>
                ...
                <dt class="mt-2 mb-2">
                    ...
                    <p class="font-light text-sm dark:text-dark-400">
                        Strings blocked from use in short URL endings due to system reservations, blacklisting, or potential
                        conflicts.
                    </p>
                </dt>
                <dd class="mt-2 mb-2">
                ...
                <dt class="mt-2">
                    ...
                    <p class="font-light text-sm dark:text-dark-400">This is a list of domain names that are not allowed to
                        be shortened.</p>
                </dt>
                <dd class="mt-2">
                    <div class="card bg-gray-50! dark:bg-dark-950/50! rounded! px-3 py-2 text-sm">
